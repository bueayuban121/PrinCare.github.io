...
function seedData(db) {
  ...
  // Doctors
  const insertDoc = db.prepare('INSERT INTO doctors (id, name, dept, position, seniority, specialty, license, status, avatar, phone, email, constraints_note, user_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)');
  [
